...
def _cross_training_flags(
                ...
                flags.append(
                    {
                        ...
                        "severity": "high" if hours_before <= 24 else "medium",
    ...
    if any(flag.get("type") == "sprint_power_declining" for flag in cycling_flags) and lower_body_sessions:
        flags.append(
            {
                "type": "sprint_power_declining_with_lower_body_lifting_present",
                "severity": "medium",
                "note": "Check whether lower-body lifting volume or placement is suppressing sprint outputs.",
            }
        )

    if any(flag.get("type") == "insufficient_recovery_before_planned_sprint_day" for flag in cycling_flags):
        flags.append(
            {
